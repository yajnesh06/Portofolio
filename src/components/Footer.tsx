      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-white mb-4 font-gilroy">Yajnesh Ponnappa</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-semibold text-white mb-4 font-gilroy">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-xl font-semibold text-white mb-4 font-gilroy">Services</h3>
            <ul className="space-y-2">
          ...
          {/* Contact */}
          <div>
            <h3 className="text-xl font-semibold text-white mb-4 font-gilroy">Contact</h3>
            <ul className="space-y-2">
